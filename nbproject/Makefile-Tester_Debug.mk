...
${TESTDIR}/tests/ecu_lua_scrip_test_runner.o: tests/ecu_lua_scrip_test_runner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/lua5.2 -ISelene/include -Isrc `pkg-config --cflags lua5.2` -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ecu_lua_scrip_test_runner.o tests/ecu_lua_scrip_test_runner.cpp
