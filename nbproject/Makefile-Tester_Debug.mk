...
${TESTDIR}/src/tests/uds_server_test.o: src/tests/uds_server_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/lua5.2 -ISelene/include -Isrc `pkg-config --cflags lua5.2` -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/uds_server_test.o src/tests/uds_server_test.cpp


${TESTDIR}/src/tests/uds_server_test_runner.o: src/tests/uds_server_test_runner.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/lua5.2 -ISelene/include -Isrc `pkg-config --cflags lua5.2` -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/uds_server_test_runner.o src/tests/uds_server_test_runner.cpp
