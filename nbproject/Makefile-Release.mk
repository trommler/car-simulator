...
${OBJECTDIR}/src/CAN_UDS_Layer.o: src/CAN_UDS_Layer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CAN_UDS_Layer.o src/CAN_UDS_Layer.cpp

${OBJECTDIR}/src/SocketCAN.o: src/SocketCAN.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SocketCAN.o src/SocketCAN.cpp
...
${OBJECTDIR}/src/CAN_UDS_Layer_nomain.o: ${OBJECTDIR}/src/CAN_UDS_Layer.o src/CAN_UDS_Layer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CAN_UDS_Layer_nomain.o src/CAN_UDS_Layer.cpp;\
	else  \
...
${OBJECTDIR}/src/SocketCAN_nomain.o: ${OBJECTDIR}/src/SocketCAN.o src/SocketCAN.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I/usr/include/lua5.2 -ISelene/include `pkg-config --cflags lua-5.2` -std=c++14  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SocketCAN_nomain.o src/SocketCAN.cpp;\
	else  \
